...
class UI_MainWindow(object):
    def setup_ui(self, parent):
        ...
        self.credits_frame.setMinimumHeight(24)
        self.credits_frame.setMaximumHeight(24)

        # CREATE LAYOUT
        self.credits_layout = QHBoxLayout(self.credits_frame)
        ...
        tstyle = "QPushButton:hover,QToolButton:hover {background-color: " + self.themes['app_color']['context_hover'] + ";}"
        
        #add toolbar
        self.sshtbar = QToolBar()
        self.load_pages.laytest.addWidget(self.sshtbar)
        self.tbplug = QToolButton()
        self.tbplug.setIcon(QIcon(Functions.set_png_icon("plug.png")))
        self.tbplug.setStyleSheet(tstyle)
        self.tbplug.setEnabled(False)
        self.tbplug.setToolTip("Connect to Server")
        self.sshtbar.addWidget(self.tbplug)
        self.sshtbar.addSeparator()
        self.tbadd = QToolButton()
        self.tbadd.setIcon(QIcon(Functions.set_png_icon("plug_add.png")))
        self.tbadd.setStyleSheet(tstyle)
        self.tbadd.setToolTip("Add New Connection")
        self.sshtbar.addWidget(self.tbadd)
        self.tbdel = QToolButton()
        self.tbdel.setIcon(QIcon(Functions.set_png_icon("plug_delete.png")))
        self.tbdel.setStyleSheet(tstyle)
        self.tbdel.setToolTip("Delete Selected Connection(s)")
        self.tbdel.setEnabled(False)
        self.sshtbar.addWidget(self.tbdel)

        self.cboConnections = QComboBox()
        self.credits_layout.addWidget(self.cboConnections)
        self.cboConnections.setStyleSheet(f"background: {self.themes['app_color']['dark_one']}")
        ...
        self.btnDisconnect.setMaximumWidth(24)
