...
################################################################################
## Form generated from reading UI file 'right_columnQUghLG.ui'
##
...
class Ui_RightColumn(object):
    def setupUi(self, RightColumn):
        ...
        self.frame_2.setBaseSize(QSize(0, 40))
        ...
        self.btn_1 = QPushButton(self.menu_1)
    ...
    def retranslateUi(self, RightColumn):
        ...
        self.btn_1.setText(QCoreApplication.translate("RightColumn", u"PushButton", None))
